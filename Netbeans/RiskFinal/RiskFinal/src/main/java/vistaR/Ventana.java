...
public class Ventana extends JFrame{
    ...
    private void initComponents(){
        ...
        this.add(hasta);
        /*Image im= new ImageIcon("src/main/java/Images/ledRectangule3.png").getImage();
        ImageIcon im2=new ImageIcon(im.getScaledInstance(140,40,Image.SCALE_SMOOTH));
        this.img.setIcon(im2);
        this.img.setBounds(15, 127, 140, 40);
        this.add(img);
        
        this.turno.setBounds(30, 140, 240, 15);
        this.turno.setFont(new Font("Georgia",Font.PLAIN,15));
